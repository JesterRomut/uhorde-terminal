            ...
            typography: () => ({
                ...
                console: {
                    css: {
                        ...
                        "--tw-prose-headings": "var(--color-slate-300)",
                        "--tw-prose-lead": "var(--color-slate-300)",
                        "--tw-prose-links": "var(--color-slate-300)",
                        "--tw-prose-bold": "var(--color-slate-300)",
                        "--tw-prose-counters": "var(--color-slate-300)",
                        ...
                        "--tw-prose-captions": "var(--color-slate-300)",
                        "--tw-prose-code": "var(--color-slate-300)",
                        "--tw-prose-pre-code": "var(--color-slate-300)",
                        "--tw-prose-pre-bg": "var(--color-slate-300)",
